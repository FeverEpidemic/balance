...
export function DashboardContent({
  ...
  const [activeTab, setActiveTab] = useState<"ringkasan" | "dompet" | "aktivitas">("ringkasan");
  const tabs = [
    { key: "ringkasan" as const, label: t("dashboard.tabRingkasan") },
    { key: "dompet" as const, label: t("dashboard.tabDompet") },
    { key: "aktivitas" as const, label: t("dashboard.tabAktivitas") },
  ];
      ...
      {activeTab === "ringkasan" && (
        <>
          ...
          <section className="mt-4 card">
            ...
            {hasDailyExpenses ? (
              <DashboardDailyExpenseChart dailyExpenses={dashboard.dailyExpenses} locale={locale} compact />
            ) : (
              <div className="mt-6">
